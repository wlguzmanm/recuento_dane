...
public class EsquemaUnidadesEnvioViewModel {
    ...
    public String getId_unidad_economica() {
        return id_unidad_economica;
    }

    public void setId_unidad_economica(String id_unidad_economica) {
    ...
    public String getId_manzana_edificio_unidad() {
        return id_manzana_edificio_unidad;
    }

    public void setId_manzana_edificio_unidad(String id_manzana_edificio_unidad) {
