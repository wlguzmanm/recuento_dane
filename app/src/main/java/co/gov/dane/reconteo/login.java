...
import co.gov.dane.reconteo.assets.utilidades.ViewComponent;
    ...
    public void onCreate(Bundle icicle) {
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String rol = null;
                try {
                    String user = decode.decodeJwt(token).getClaim("preferred_username").asString();
                    Claim resource_access = decode.decodeJwt(token).getClaim("resource_access");
                   ...
                   // String resourceAccessStr  = resourceJson.toJson(resource_access);
                    ...
                    JSONObject jsonDane = new JSONObject("{\"danemonitoreo\":{\"roles\":[\"Supervisor\"]},\"account\":{\"roles\":[\"manage-account\",\"manage-account-links\",\"view-profile\"]}}");
                ...
                session.setusename(username.getText().toString(),
                        decode.decodeJwt(token).getClaim("name").asString(),
                        rol,
                        token,
