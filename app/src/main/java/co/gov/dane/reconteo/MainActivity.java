...
import co.gov.dane.reconteo.adapter.ConteoAdapterManzana;
...
import co.gov.dane.reconteo.model.ConteoManzana;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (dbFile.exists()) {
                ...
                String outFileName = "/data/data/co.gov.dane.reconteo/databases/geom.db";
